...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  //  UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier: forIndexPath:indexPath];
    ...
    cell.titleArc.text=_var[indexPath.row][@"lf"];
    ...
    cell.SinceArc.text=[NSString stringWithFormat:@"%@ %@",cell.SinceArc.text,_var[indexPath.row][@"since"]];
    cell.frequencyArc.text =[NSString stringWithFormat:@"%@ %@",cell.frequencyArc.text,_var[indexPath.row][@"freq"]];
